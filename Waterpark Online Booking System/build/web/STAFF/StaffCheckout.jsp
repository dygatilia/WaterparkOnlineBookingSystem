                ...
                <div class="card">
                    <header class="card-header">
                        <p class="card-header-title">
                            ...
                            Checkout
                                ...
                                CheckoutStaff checkout = checkoutdao.retrieveCheckoutStaffByBookingStaffId(bookstaffid);

                                BookedTicketsStaffDAO bookedticketsdao = new BookedTicketsStaffDAOImpl();
                                BookedTicketsStaff bookedticket = bookedticketsdao.retrieveBookedTicketsStaffByBookingStaffId(bookstaffid);

                                BookedFacilitiesStaffDAO bookedfacilitiesdao = new BookedFacilitiesStaffDAOImpl();
                                BookedFacilitiesStaff bookedfacilities = bookedfacilitiesdao.retrieveBookedFacilitiesStaffByBookingStaffId(bookstaffid);
                            %>
                    <div class="card-content">
                        <form action="../BookingStaffController">
                                ...
                                <div class="control">
                                    <div class="select is-fullwidth">
                                        <select name="paymenttype">
                                            <option selected value="Credit/Debit Card">Credit/Debit Card</option>
                            ...
                            <input type="hidden" name="amount" value="<%=checkout.getCheckoutamount()%>"/>
                            ...
                            <div class="field grouped">
                                ...
                                <div class="control">
                                    <button type="submit" name = "command" value = "saveCheckout" class="button green">
                                        Checkout
                                    </button>
                                </div>
                            </div>
