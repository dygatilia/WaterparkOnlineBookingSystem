                ...
                <div class="card">
                    <header class="card-header">
                        <p class="card-header-title">
                            ...
                            Book Ticket Form (Add On Some Facilities!)
                        </p>
                    </header>
                    <div class="card-content">
                        <form action="<%=request.getContextPath()%>/BookingStaffController" method="POST">
                            <%
                                ...
                                int bookingstaffid = Integer.parseInt(bookstaffid);
                                ...
                                BookedTicketsStaff bookedtic = bookedticketsstaffdao.retrieveBookedTicketsStaffByBookingStaffId(bookingstaffid);
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input class="input is-danger" type="number" name="qty<%=count%>" value="0" min="0">
                                            </td>
                                            <td>
                                                <%=totalAvailable%>
                            ...
                            <input name="bookingstaffid" type="hidden" value="<%=bookingstaffid%>">
                            <input name="bookedticketid" type="hidden" value="<%=bookedtic.getBookedticid()%>">
                            <input type="hidden" name="date" value="<%=datee%>">
                            <div class="field grouped">
                                <div class="control">
                                    <button type="submit" name = "command" value = "cancelBookedTic" class="button red">
                                        Cancel
                                    </button>
                                </div>
                                <div class="control">
                                    <button type="submit" name = "command" value = "saveBookedFac" class="button green">
                                        Next
                                    </button>
                                </div>
                            </div>
