                ...
                <div class="grid gap-6 grid-cols-1 md:grid-cols-3 mb-6">
                    <%
                        for (Booking booking : bookinglist){
                            ...
                            if(booking.getBookingDate().equals(currentDay)){
                        ...
                        <div class="card-content">
                            <div class="flex items-center justify-between">
                                <div class="widget-label">
                                    ...
                                    <h2>
                                        Online Customer - <%=totalticket%> &nbsp; &nbsp; <a href="../CUSTOMER/CustInvoice.jsp?id=all&date=<%=currentDay%>"><i class="mdi mdi-eye"></i></a>
                                    </h2>
                                    <%
                                        int total = 0;
                                        ...
                                        for (BookingStaff bookingstaff : bookingstafflist){
                                            ...
                                            if(bookingstaff.getBookingDate().equals(currentDay)){
                                    ...
                                    %>
                                    <h2>
                                        Walk-in Customer - <%=total%> &nbsp; &nbsp; <a href="StaffInvoice.jsp?id=all&date=<%=currentDay%>"><i class="mdi mdi-eye"></i></a>
                                    </h2>
                                </div>
