                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
                    ...
                    <div class="navbar-menu" id="navbar-menu">
                        <div class="navbar-item dropdown has-divider has-user-avatar">
                            ...
                            <div class="navbar-dropdown">
                                <a href="StaffHistoryAll.jsp" class="navbar-item">
                            ...
                            <tbody>
                                <%
                                    ...
                                    for (Booking booking : bookinglist){
                                        ...
                                        if ((order.getOrderStatus().equals("Invalid")) && (booking.getBookingDate().equals(currentDay))){
                                %>
                                <tr>
                            ...
                            <tbody>
                                <%
                                    ...
                                    for (BookingStaff bookingstaff : bookingstafflist){
                                        ...
                                        if ((orderstaff.getOrderStaffStatus().equals("Invalid")) && (bookingstaff.getBookingDate().equals(currentDay))){
                                %>
                                <tr>
