            ...
            <section class="is-hero-bar">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
                    ...
                    <div class="navbar-menu" id="navbar-menu">
                        <div class="navbar-item dropdown has-divider has-user-avatar">
                            <a class="navbar-link">
                                <h1><span>Today (<%=currentDay%>)</span></h1>
                                <span class="icon"><i class="mdi mdi-chevron-down"></i></span>
                            </a>
                            <div class="navbar-dropdown">
                                <a href="StaffBookedAll.jsp" class="navbar-item">
                            ...
                            <tbody>
                                <%
                                    ...
                                    for (Booking booking : bookinglist){
                                        ...
                                        if ((order.getOrderStatus().equals("Valid")) && (booking.getBookingDate().equals(currentDay))){
                                %>
                                <tr>
                                    ...
                                    <td class="actions-cell">
                                        <div class="buttons right nowrap">
                                            <form action="../BookingController">
                                                ...
                                                <input type="hidden" name="bookid" value="<%=order.getBookingID()%>"/>
                                                <input type="hidden" name="orderstatus" value="Invalid"/>
                                                <button class="button small green" type="submit" name = "command" value = "updateStatus">
                                                    <span class="icon"><i class="mdi mdi-checkbox-marked-circle"></i></span>
                                                </button>
                                            </form>
                            ...
                            <tbody>
                                <%
                                    ...
                                    for (BookingStaff bookingstaff : bookingstafflist){
                                        ...
                                        if ((orderstaff.getOrderStaffStatus().equals("Valid")) && (bookingstaff.getBookingDate().equals(currentDay))){
                                %>
                                <tr>
                                    ...
                                    <td data-label="BookingStatus"><%=orderstaff.getOrderStaffStatus()%></td>
                                    <td class="actions-cell">
                                        <div class="buttons right nowrap">
                                            <form action="../BookingStaffController">
                                                <input type="hidden" name="orderstaffid" value="<%=orderstaff.getOrderStaffID()%>"/>
                                                <input type="hidden" name="bookstaffid" value="<%=orderstaff.getBookingStaffID()%>"/>
                                                <input type="hidden" name="orderstaffstatus" value="Invalid"/>
                                                <button class="button small green" type="submit" name = "command" value = "updateStatus">
                                                    <span class="icon"><i class="mdi mdi-checkbox-marked-circle"></i></span>
                                                </button>
                                            </form>
                                            <button class="button small blue" type="button">
                                                <a href="../STAFF/StaffInvoice.jsp?id=<%=bookingstaff.getBookingStaffID()%>"><span class="icon"><i class="mdi mdi-eye"></i></span>
                                            </button>
                                        </div>
                                    </td>
                                </tr>
