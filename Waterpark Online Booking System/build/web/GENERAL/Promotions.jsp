        ...
        <div class="overflow-hidden bg-gray-900 -mt-32 pt-32">
            ...
            <div class="relative bg-gray-900 mt-3 px-4 sm:px-6 lg:px-10 pb-14 lg:pb-20 xl:pb-28">
                <div class="text-justify mt-3">
                    ...
                    %>
                    <div class="items-center flex-1 flex flex-col justify-center pt-10 lg:pt-10 lg:pb-8">
                        <img src="../img/imagePromotions.jsp?id=<%=promo.getPromotionsID()%>" alt="Promo Image" style="width:50%">
                    </div>
                    <%
                        }
                    %>
