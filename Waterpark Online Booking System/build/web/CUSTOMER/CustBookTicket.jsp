                                ...
                                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                    ...
                                    <form action="<%=request.getContextPath()%>/BookingController" method="POST">
                                        <%
                                            ...
                                            Booking bookingg = bookingdaoo.retrieveBookingByCustomerId(customerid);

                                            DailyTicketDAO dailyticketdao = new DailyTicketDAOImpl();
                                            DailyTicket dailyticket = dailyticketdao.retrieveDailyTicket();
                                        %>
                                        <input type="hidden" name="remember" value="true">
                                        <div class="relative flex flex-row justify-between w-full mt-3">
                                            <label class="block uppercase text-gray-700 text-sm font-bold" for="grid-password">Tickets Type</label>
                                            <label class="block uppercase text-gray-700 text-sm font-bold mr-2" for="grid-password">Tickets Available: <%=dailyticket.getDailyticketmax() - totalticket%></label>
                                        </div>
                                        <div class="w-full">
                                                    ...
                                                    <table class="items-center w-full border-collapse">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <th class="border-t-0 pl-24 pt-6 align-middle border-l-0 border-r-0 text-xs uppercase whitespace-nowrap text-left">
                                                                    Price
                                                                </th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="border-t-0 pl-24 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap">
                                                                    RM <%=tickets.getPrice()%>0
                                                                </td>
                                                                <td class="border-t-0 pl-44 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap">
                                                                    <div class="flex">
                                                                        <div>
                                                                            <input type="hidden" name="hidticketid<%=counter%>" value="<%=tickets.getTicketID()%>">
                                                                            <input type="number" name="qty<%=counter%>" class="form-control w-1/3 py-2 text-xs text-gray-700 bg-white bg-clip-padding border-0 rounded-lg shadow transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        ...
                                        <div class="btn-wrapper text-center mt-10">
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name = "command" value = "cancelBooking" style="transition: all 0.15s ease 0s;">
                                                CANCEL
                                            </button>
                                            ...
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name = "command" value = "saveBookedTic" style="transition: all 0.15s ease 0s;">
                                                NEXT
                                            </button>
                                        </div>
