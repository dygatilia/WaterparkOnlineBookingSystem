                                ...
                                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                    <form action="../BookingController">
                                        ...
                                        <div class="relative w-full mb-3">
                                            <label class="block uppercase text-gray-700 text-sm font-bold mb-2" for="paymenttype">Payment Type</label>
                                            <div class="relative w-1/3 mb-3">
                                                <select id="paymenttype" name="paymenttype" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                        ...
                                        <div class="btn-wrapper text-center mt-6">
                                            ...
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name = "command" value = "saveCheckout" style="transition: all 0.15s ease 0s;">
                                                NEXT
                                            </button>
                                        </div>
                                    </form>
