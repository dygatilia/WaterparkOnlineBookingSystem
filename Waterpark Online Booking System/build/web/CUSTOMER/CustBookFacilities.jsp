                            ...
                            <ul class="flex-col md:flex-row list-none items-center hidden md:flex">
                                ...
                                <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1" style="min-width: 12rem;" id="user-dropdown">
                                    <ul class="py-1 text-sm text-black dark:text-gray-900" aria-labelledby="dropdownLargeButton">
                                        ...
                                        <li>
                                            <a href="p" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Settings</a>
                                        </li>
                                        <li>
                                ...
                                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                    <form action="<%=request.getContextPath()%>/BookingController" method="POST">
                                        <%
                                            ...
                                            BookedTickets bookedtic = bookedticketsdao.retrieveBookedTicketsByBookingId(bookingid);
                                            ...
                                            <table class="items-center border-collapse">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th class="border-t-0 pr-2 pt-6 align-middle border-l-0 border-r-0 text-xs uppercase whitespace-nowrap text-left">
                                                            Quantity Available
                                                        </th>
                                                    </tr>
                                                    <%
                                                        ...
                                                        for (Facilities facilities : facilitieslist) {
                                                            ...
                                                            for (Booking booking : bookinglist){
                                                                ...
                                                                if(booking.getBookingDate().equals(datee)){
                                                                    ...
                                                                    totalfacs = totalfacs + bookedfac.getQuantity();
                                                                }
                                                            }
                                                            ...
                                                            for (BookingStaff bookingstaff : bookingstafflist){
                                                                ...
                                                                if(bookingstaff.getBookingDate().equals(datee)){
                                                                    ...
                                                                    BookedFacilitiesStaff bookedfacstaff = bookedfacilitiesstaffdao.retrieveQuantityByFacilitiesIDnBookingStaffID(facilities.getFacilitiesID(), bookingstaff.getBookingStaffID());

                                                                    totalfacss = totalfacss + bookedfacstaff.getQuantity();
                                                                }
                                                            }
                                                            
                                                            total = totalfacs + totalfacss;
                                                            
                                                            totalAvailable = facilities.getFacilitiesQuantity() - total;
                                                    %>
                                                    <tr>
                                                        ...
                                                        <td class="border-t-0 pl-20 border-l-0 border-r-0 text-xs whitespace-nowrap">
                                                            <div class="flex justify-center">
                                                                <div>
                                                                    <input type="hidden" name="hidfacilitiesid<%=count%>" value="<%=facilities.getFacilitiesID()%>">
                                                                    <input type="number" name="qty<%=count%>" class="form-control w-1/3 py-2 text-xs text-gray-700 bg-white bg-clip-padding border-0 rounded-lg shadow transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                           id="exampleNumber0" value="0" min="0"/>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="border-t-0 pr-2 align-middle text-center border-r-0 border-r-0 text-xs whitespace-nowrap">
                                                            <%=totalAvailable%>
                                                            <input type="hidden" name="totalAvailable<%=count%>" value="<%=totalAvailable%>"/>
                                                        </td>
                                                    </tr>
                                                    <%
                                                        count++;
                                        ...
                                        <div class="btn-wrapper text-center mt-10">
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name = "command" value = "cancelBookedTic" style="transition: all 0.15s ease 0s;">
                                                CANCEL
                                            </button>
                                            <input type="hidden" name="count" value="<%=count-1%>">
                                            <input name="bookingid" type="hidden" value="<%=bookingid%>">
                                            <input name="bookedticketid" type="hidden" value="<%=bookedtic.getBookedticid()%>">
                                            ...
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name = "command" value = "saveBookedFac" style="transition: all 0.15s ease 0s;">
                                                NEXT
                                            </button>
                                        </div>
                                        <div class="text-center text-xs mt-5">
                                            <span style="color:red">${errorfacExceed}</span>
                                        </div>
                                    </form>
                                </div>
                            </div>
