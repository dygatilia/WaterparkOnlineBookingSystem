...
<html lang="en" class="">
    <head>
        ...
        <title>Edit Tickets || Manager</title>
        ...
        <div id="app">
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <%
                        String ticketsid = request.getParameter("id");
                        TicketsDAO ticketsdao = new TicketsDAOImpl();
                        Tickets tickets = ticketsdao.retrieveTicketsByTicketsId(Integer.parseInt(ticketsid));
                    %>
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="name" type="text" placeholder="Ticket Type" value="<%=tickets.getTicketName()%>">
                                            <span class="icon left"><i class="mdi mdi-ticket"></i></span>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label class="label">Price</label>
                                        <div class="control icons-left">
                                            <input class="input" name="price" id="price" type="text" placeholder="0.00" value="<%=tickets.getPrice()%>0">
