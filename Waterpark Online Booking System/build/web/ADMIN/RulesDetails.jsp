...
<html lang="en" class="">
    <head>
        ...
        <title>Add New Rules & Regulations || Manager</title>
        ...
        <div id="app">
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <%
                        String rulesid = request.getParameter("id");
                        RulesDAO rulesdao = new RulesDAOImpl();
                        Rules rules = rulesdao.retrieveRulesByRulesId(Integer.parseInt(rulesid));
                    %>
                    <div class="card-content">
                        <form action="../RulesController">
                            <div class="field">
                                <div class="field-body">
                                    <div class="field">
                                        <label class="label">Description</label>
                                        <div class="control icons-left">
                                            <textarea class="textarea" name="desc" placeholder="Type a rules & regulations..."><%=rules.getRulesDesc()%></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
