...
<%@page import="MODEL.Rules"%>
<%@page import="DAOImpl.RulesDAOImpl"%>
<%@page import="DAO.RulesDAO"%>
...
<html lang="en" class="">
    ...
    <body>
        ...
        <section class="is-title-bar">
            <a href="AdminAddFeatures.jsp" class="button blue">
                <span class="icon"><i class="mdi mdi-city"></i></span>
                <span>ADD ATTRACTIONS</span>
            </a>
            <a href="AdminAddRules.jsp" class="button blue">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td class="image-cell">
                                    <div class="image">
                                        <img class="rounded-full" src="../img/image.jsp?id=<%=feature.getFeaturesID()%>" alt="Features Image">
                                    </div>
                                </td>
                                <td data-label="name">
                                    <a class="hover:text-blue-500 hover:underline" href="FeaturesDetails.jsp?id=<%=feature.getFeaturesID()%>"><%=feature.getFeaturesName()%></a>
                                </td>
                                <td data-label="description"><%=feature.getFeaturesDesc()%></td>
                                <td data-label=""></td>
                                <td data-label="" class=""></td>
                                <td data-label=""></td>
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        <a href="FeaturesDetails.jsp?id=<%=feature.getFeaturesID()%>" class="button small green">
                                            <span class="icon"><i class="mdi mdi-eye"></i></span>
                                        </a>
                                        <a href="EditFeatures.jsp?id=<%=feature.getFeaturesID()%>" class="button small blue">
                                            <span class="icon"><i class="mdi mdi-pencil"></i></span>
                                        </a>
                                        <form action="<%=request.getContextPath()%>/FeaturesController" method="POST">
                                            <input type="hidden" name="hidid" value="<%=feature.getFeaturesID()%>">
                ...
                <div class="card-content">
                    <table>
                        ...
                        <%
                            ...
                            List<Rules> ruleslist = rulesdao.retrieveAll();
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td data-label="Desc"><%=rules.getRulesDesc()%></td>
                                <td data-label=""></td>
                                <td data-label="" class=""></td>
                                <td data-label=""></td>
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        <a href="RulesDetails.jsp?id=<%=rules.getRulesID()%>" class="button small blue">
                                            <span class="icon"><i class="mdi mdi-pencil"></i></span>
                                        </a>
                                        <form action="<%=request.getContextPath()%>/RulesController" method="POST">
                                            <input type="hidden" name="hidid" value="<%=rules.getRulesID()%>">
                                            <button  onclick="return confirm('Are you sure to delete?')" type="submit" name="command" value="delete" class="button small red">
                                                <span class="icon"><i class="mdi mdi-trash-can"></i></span>
                                            </button>
                                        </form>
