...
<html lang="en" class="">
    <head>
        ...
        <title>Dashboard Daily Ticket || Manager</title>
        ...
        <div id="app">
            ...
            <section class="is-hero-bar">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
                    ...
                    <div class="navbar-menu" id="navbar-menu">
                        <div class="navbar-item dropdown has-divider has-user-avatar">
                            <a class="navbar-link">
                                <h1><span>This Month (<%=currentMonth%>)</span></h1>
                                <span class="icon"><i class="mdi mdi-chevron-down"></i></span>
                            </a>
                            <div class="navbar-dropdown">
                                ...
                                <a href="AdminDashboardNext.jsp" class="navbar-item">
            ...
            <section class="section main-section">
                <div class="grid gap-6 grid-cols-1 md:grid-cols-3 mb-6">
                    <%
                        ...
                        for (BookingStaff bookingstaff : bookingstafflist){                            
                            ...
                            if(bookingMonth.equals(currentMonth)){
                                ...
                                totalsalesstaff = totalsalesstaff + (checkoutstaff.getCheckoutamount());
                            }
                        }
                        
                        total = totalsales + totalsalesstaff;
                                ...
                                <div class="widget-label">
                                    <h3>
                                        ...
                                        <span class="icon text-blue-500">
                                            <a href="AdminDashboardTicket.jsp">
                    ...
                    %>
                    <form action="<%=request.getContextPath()%>/DashboardController" method="POST">
                        <input type="hidden" name="dailyticketid" value="<%=dailyticket.getDailyticketid()%>"/>
                        <div class="card">
                            <div class="card-content">
                                <div class="flex items-center justify-between">
                                    <div class="widget-label">
                                        <h3>
                                            Daily Total Ticket
                                            <button type="submit" name="command" value="updateDailyTicket" class="large white">
                                                <span class="icon text-blue-500">
                                                    <a href="AdminDashboardEditDailyTicket.jsp">
                                                        <i class="mdi mdi-pencil w-5 h-5" data-bs-toggle="tooltip" title="Click to update."></i>
                                                    </a>
                                                </span>
                                            </button>
                                        </h3>
                                        <h1>
                                            <input type="text" name="dailyticketmax" value="<%=dailyticket.getDailyticketmax()%>" maxlength="5" size="2"/>
                                        </h1>
                                    </div>
