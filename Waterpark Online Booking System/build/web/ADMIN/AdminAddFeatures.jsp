...
<html lang="en" class="">
    <head>
        ...
        <title>Add New Features || Manager</title>
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <div class="card-content">
                        <form action="<%=request.getContextPath()%>/FeaturesController" method="POST" enctype="multipart/form-data">
                            <div class="field">
