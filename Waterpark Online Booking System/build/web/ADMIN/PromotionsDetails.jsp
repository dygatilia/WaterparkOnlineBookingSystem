...
<html lang="en" class="">
    <head>
        ...
        <title>Promotions Details || Manager</title>
        ...
        <div id="app">
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <%
                        String promotionsid = request.getParameter("id");
                        PromotionsDAO promodao = new PromotionsDAOImpl();
                        Promotions promo = promodao.retrievePromotionsByPromotionsID(Integer.parseInt(promotionsid));
                    %>
                    <div class="card-content">
                        <form action="../PromotionsController" method="POST" enctype="multipart/form-data">
                            <div class="field">
                                <div class="field-body">
                                        ...
                                        <div class="field-body">
                                            <div class="field file">
                                                <div class="image w-48">
                                                    <img src="../img/imagePromotions.jsp?id=<%=promo.getPromotionsID()%>" alt="Promo Image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="code" type="text" readonly placeholder="Promotions' Code" value="<%=promo.getPromotionsCode()%>">
                                            <span class="icon left"><i class="mdi mdi-ticket-percent"></i></span>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label class="label">Discount Off</label>
                                        <div class="control icons-left">
                                            <input class="input" name="discount" type="text" readonly placeholder="Promotions' Discount Off" value="<%=promo.getPromotionsDiscount()%>">
                                            <span class="icon left"><i class="mdi mdi-ticket-percent"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="field grouped">
                                <div class="buttons right nowrap">
                                    <a href="EditPromotions.jsp?id=<%=promo.getPromotionsID()%>" class="button blue">
                                        Edit
                                    </a>
                                </div>
                            </div>
