                    ...
                    <div class="flex content-center items-center justify-center h-full">
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
                                ...
                                <div class="flex-auto w-full px-4 lg:px-10 py-10 pt-0">
                                    <%
                                        int checkoutid = Integer.parseInt(request.getParameter("id"));
                                        
                                        CheckoutDAO checkoutdao = new CheckoutDAOImpl();
                                        Checkout checkout = checkoutdao.retrieveCheckoutByCheckoutId(checkoutid);
                                        ...
                                        //discount = (checkout.getCheckoutamount() * ((Double.valueOf(promo.getPromotionsDiscount()) / 100)));
                                        //BigDecimal bd = new BigDecimal(discount).setScale(2, RoundingMode.HALF_UP);
                                        //double disc = bd.doubleValue();

                                        //totalamount = (checkout.getCheckoutamount() - disc); 
                                    ...
                                    <form action="../BookingController">
                                        <div class="relative">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="pr-8">
                                                        <label class="block uppercase text-gray-700 text-sm font-bold" for="grid-password">Payment Method:</label>
                                                    </td>
                                                    <td class="px-36">
                                                        <label class="block uppercase text-gray-700 right text-xs font-bold" for="grid-password"><%=checkout.getPaymenttype()%></label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        <%--<div class="relative mt-10">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="pr-8">
                                                        <label class="block uppercase text-gray-700 text-sm font-bold" for="grid-password">Booking Total:</label>
                                                    </td>
                                                    <td class="px-40">
                                                        <label class="block uppercase text-gray-700 right text-xs font-bold" for="grid-password">RM <%=checkout.getCheckoutamount()%>0</label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>--%>  
                                        <%--<div class="relative mt-2">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="">
                                                        <label class="block uppercase text-gray-700 text-sm font-bold" for="grid-password">Promotions Discount:</label>
                                                    </td>
                                                    <td class="px-32 text-right">
                                                        <label class="block uppercase text-gray-700 right text-xs font-bold" for="grid-password">-RM <%=disc%>0</label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>--%>        
                                        ...
                                        <div class="btn-wrapper text-center mt-6">
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name="command" value="cancelCheckout" style="transition: all 0.15s ease 0s;">
                                                CANCEL
                                            </button>
                                            ...
                                            <input type="hidden" name="paymenttype" value="<%=checkout.getPaymenttype()%>"/>
                                            <input type="hidden" name="amount" value="<%=totalamount%>"/>
                                            <input type="hidden" name="orderstatus" value="Valid"/>
                                            <button class="--jb-modal bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="submit" name = "command" value = "savePayment" style="transition: all 0.15s ease 0s;">
                                                PAY
                                            </button>
                                        </div>
                                    </form>
