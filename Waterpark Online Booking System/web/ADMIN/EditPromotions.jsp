...
<html lang="en" class="">
    <head>
        ...
        <title>Edit Promotions || Manager</title>
                    ...
                    <div class="card-content">
                        <form action="../PromotionsController" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="field-body">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="code" type="text" placeholder="Promotions' Code" value="<%=promo.getPromotionsCode()%>">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="discount" type="text" placeholder="Promotions' Discount Off" value="<%=promo.getPromotionsDiscount()%>">
                                            <span class="icon left"><i class="mdi mdi-ticket-percent"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="field grouped">
                                <div class="control">
                                    <div class="control">
                                        <button type="submit" name="command" value="update" class="button green" onclick="alert('Your changes have been successfully updated');">
                                            Update
                                        </button>
                                    </div>
