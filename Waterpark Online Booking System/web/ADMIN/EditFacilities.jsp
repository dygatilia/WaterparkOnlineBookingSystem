...
<html lang="en" class="">
    <head>
        ...
        <title>Edit Facilities || Manager</title>
                                ...
                                <div class="field-body">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="name" type="text" placeholder="Facilities's Name" value="<%=facilities.getFacilitiesName()%>">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="price" id="price" type="text" placeholder="0.00" value="<%=facilities.getFacilitiesPrice()%>0">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input class="input" name="quantity" type="number" placeholder="0" value="<%=facilities.getFacilitiesQuantity()%>">
                                        </div>
                                    </div>
                                </div>
                            </div>
