...
<html lang="en" class="">
    <head>
        ...
        <title>Add New Facilities || Manager</title>
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <div class="card-content">
                        <form action="<%=request.getContextPath()%>/FacilitiesController" method="POST" enctype="multipart/form-data">
                            <div class="field">
                                <div class="field-body">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="name" type="text" placeholder="Facilities's Name">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="price" id="price" type="text" placeholder="0.00">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input class="input" name="quantity" type="number" placeholder="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
