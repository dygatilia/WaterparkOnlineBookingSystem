...
<html lang="en" class="">
    <head>
        ...
        <title>Features Details || Manager</title>
                        ...
                        <form action="../FeaturesController" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="field-body">
                                        ...
                                        <div class="field-body">
                                            <div class="field file">
                                                <div class="image w-48">
                                                    <img src="../img/image.jsp?id=<%=features.getFeaturesID()%>" alt="Features Image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="name" type="text" readonly placeholder="Name" value="<%=features.getFeaturesName()%>">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left icons-right">
                                            <textarea class="textarea" name="description" readonly placeholder="Description"><%=features.getFeaturesDesc()%></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="field grouped">
                                <div class="buttons right nowrap">
                                    <a href="EditFeatures.jsp?id=<%=features.getFeaturesID()%>" class="button blue">
                                        Edit
                                    </a>
                                </div>
                            </div>
