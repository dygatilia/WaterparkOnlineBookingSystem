...
<html lang="en" class="">
    <head>
        ...
        <title>Add New Promotions || Manager</title>
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <div class="card-content">
                        <form action="<%=request.getContextPath()%>/PromotionsController" method="POST" enctype="multipart/form-data">
                            <div class="field">
                                <div class="field-body">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="code" type="text" placeholder="Promotions Code">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="discount" type="text" placeholder="Promotions Discount">
                                            <span class="icon left"><i class="mdi mdi-ticket-percent"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="field grouped">
                                <div class="control">
                                    <button type="submit" name="command" value="save" class="button green">
                                        Add
                                    </button>
                                </div>
                                <div class="control">
