...
<html lang="en" class="">
    <head>
        ...
        <title>Edit Features || Manager</title>
        ...
        <div id="app">
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <%
                        String featuresid = request.getParameter("id");
                        FeaturesDAO featuresdao = new FeaturesDAOImpl();
                        Features features = featuresdao.retrieveFeaturesByFeaturesId(Integer.parseInt(featuresid));
                    %>
                    <div class="card-content">
                        <form action="../FeaturesController" method="POST" enctype="multipart/form-data">
                            <div class="field">
                                <div class="field-body">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name="name" type="text" placeholder="Name" value="<%=features.getFeaturesName()%>">
                                            <span class="icon left"><i class="mdi mdi-hexagon-multiple"></i></span>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label class="label">Description</label>
                                        <div class="control icons-left icons-right">
                                            <textarea class="textarea" name="description" placeholder="Description"><%=features.getFeaturesDesc()%></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="field grouped">
                                ...
                                <input type="hidden" name="hidid" value="<%=features.getFeaturesID()%>">
                                </div>
                            </div>
                        </form>
                    </div>
