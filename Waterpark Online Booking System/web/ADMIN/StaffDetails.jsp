...
<html lang="en" class="">
    <head>
        ...
        <title>Staff Details || Manager</title>
                    ...
                    <div class="card-content">
                        <form action="../UserController">
                            <div class="field">
                                <div class="field-body">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left icons-right">
                                            <input class="input" name="password" type="text" placeholder="Password" value="<%=staff.getStaffPassword()%>">
                            ...
                            <div class="field grouped">
                                <div class="control">
                                    <button type="submit" name="command" value="updateStaff" class="button green" onclick="alert('Your changes have been successfully updated');">
                                        Update
                                    </button>
                                </div>
