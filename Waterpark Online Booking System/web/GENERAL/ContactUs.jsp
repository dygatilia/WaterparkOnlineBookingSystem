        ...
        <header class="flex-none relative z-50 text-sm leading-6 font-medium text-gray-800 antialiased">
            ...
            <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
                <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                    <a href="../index.jsp" class="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-blueGray-700">
                        HOME
                    </a>
                </div>
                <div class="lg:flex flex-grow items-center hidden" id="example-navbar-danger">
                    <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="px-3 py-2 flex items-center text-xs uppercase font-bold text-blueGray-700 hover:text-blueGray-500" href="TicketPrice.jsp">
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-wrap justify-center lg:-mt-64 -mt-48">
                        <div class="w-full lg:w-6/12 px-4">
                                ...
                                <form action="../MessageServlet" method="POST">
                                    <div class="flex-auto p-5 lg:p-10">
                                        ...
                                        <div class="relative w-full mb-3 mt-8">
                                            ...
                                            <input type="text" name="name" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" 
                                        ...
                                        <div class="relative w-full mb-3">
                                            ...
                                            <input type="email" name="email" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                                   placeholder="Email" style="transition: all 0.15s ease 0s;"/>
                                        </div>
                                        <div class="relative w-full mb-3">
                                            <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="description">Subject</label>
                                            <input type="text" name="subject" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                        ...
                                        <div class="relative w-full mb-3">
                                            ...
                                            <textarea rows="4" cols="80" name="description" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                        ...
                                        <div class="text-center mt-6">
                                            <button class="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1"
                                                    type="submit" name="command" value="send" onclick="alert('Your message has been recorded. We will contact you ASAP!');" style="transition: all 0.15s ease 0s;"> 
                                                Send Message 
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center text-white mt-20 mb-20">
                                <img alt="Facilities Image" src="../img/pinIcon.png" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 100px;"/>
                                <p class="mt-5 text-xl ">PT18047/1, Jalan Kilang, Persekitaran JPJ, 26400 Bandar Jengka, Pahang</p>
                                <p class="mt-2 text-lg">09 - 4663775</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap items-top mb-6">
                            <div class="w-full lg:w-4/12 px-4 ml-auto">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a class="text-white font-semibold block pb-2 text-sm" href="Features.jsp">Attractions</a>
                                    </li>
                                    <li>
                                        <a class="text-white font-semibold block pb-2 text-sm" href="Facilities.jsp">Facilities</a>
                                    </li>
                                    <li>
                                        <a class="text-white font-semibold block pb-2 text-sm" href="TicketPrice.jsp">Ticket Price</a>
                                    </li>
                                </ul>
                            </div>
