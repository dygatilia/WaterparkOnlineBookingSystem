            ...
            <section class="pt-20 pb-48">
                <div class="container mx-auto px-4">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        %>
                        <div class="md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="Facilities Image" src="../img/imageFacilities.jsp?id=<%=facilities.getFacilitiesID()%>"
                                     class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                                <div class="pt-6 pb-20 text-center">
                                    <h5 class="text-xl text-white font-bold"><%=facilities.getFacilitiesName()%></h5>
                                    <p class="mt-1 text-md text-gray-500 uppercase font-semibold">RM <%=facilities.getFacilitiesPrice()%>0</p>
                                </div>
                            </div>
                        </div>
                        <%
                        ...
                        <div class="md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="Facilities Image" src="../img/MoreFacilities.png"
                                     class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                                <div class="pt-6 pb-20 text-center">
                                    <h5 class="text-xl text-white font-bold">Other Facilities</h5>
                                    <p class="mt-1 text-md text-gray-500 font-semibold">Changing Room</p>
                                    <p class="mt-1 text-md text-gray-500 font-semibold">Surau</p>
                                </div>
                            </div>
                        </div>
                    </div>
