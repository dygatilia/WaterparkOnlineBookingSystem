                                ...
                                <div class="widget-label">
                                    <h3>
                                        ...
                                        <span class="icon text-blue-500">
                                            <a href="StaffDashboardYesterday.jsp">
                                    ...
                                    <h2>
                                        Online Customer - <%=totalticket%> &nbsp; &nbsp; <a href="../CUSTOMER/CustInvoice.jsp?id=all&date=<%=yesterday%>"><i class="mdi mdi-eye"></i></a>
                                    </h2>
                                    <%
                                        int total = 0;
                                    ...
                                    %>
                                    <h2>
                                        Walk-in Customer - <%=total%> &nbsp; &nbsp; <a href="StaffInvoice.jsp?id=all&date=<%=yesterday%>"><i class="mdi mdi-eye"></i></a>
                                    </h2>
                                </div>
