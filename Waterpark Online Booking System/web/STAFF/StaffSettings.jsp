                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input type="text" readonly value="<%=staff.getStaffName()%>" class="input is-static">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">E-mail</label>
                                <div class="control">
                                    <input type="email" readonly value="<%=staff.getStaffEmail()%>" class="input is-static">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Password</label>
                                <div class="control">
                                    <input type="text" readonly value="<%=staff.getStaffPassword()%>" class="input is-static">
                                </div>
                            </div>
                        </div>
                    </div>
