...
<html lang="en" class="">
    <head>
        ...
        <title>Booking Form || Staff</title>
                    ...
                    <div class="card-content">
                        <form action="<%=request.getContextPath()%>/BookingStaffController" method="post">
                            <%
                                ...
                                BookingStaff bookingstaff = bookingstaffdao.retrieveBookingStaffByStaffId(staff.getStaffID());
                            ...
                            <div class="field">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control is-expanded icons-left">
                                            <input class="input" type="text" name="contactnum" placeholder="Your phone number" onkeypress="return onlyNumberKey(event)">
                            ...
                            <input name="bookingid" type="hidden" value="<%=bookingstaff.getBookingStaffID()%>">
                            <input name="total" type="hidden" value="<%=dailyticket.getDailyticketmax()%>">
                            <div class="field grouped">
                                ...
                                <div class="control">
                                    <button type="submit" name="command" value="saveBooking" class="button green">
                                        Next
                                    </button>
                                </div>
                            </div>
