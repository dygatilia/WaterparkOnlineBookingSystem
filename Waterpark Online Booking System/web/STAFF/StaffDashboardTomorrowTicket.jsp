...
<html lang="en" class="">
    <head>
        ...
        <title>Dashboard Ticket Details || Staff</title>
            ...
            <section class="is-hero-bar">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
                    ...
                    <div class="navbar-menu" id="navbar-menu">
                        <div class="navbar-item dropdown has-divider has-user-avatar">
                            <a class="navbar-link">
                                <h1><span>Tomorrow (<%=tomorrow%>)</span></h1>
                                <span class="icon"><i class="mdi mdi-chevron-down"></i></span>
                            </a>
                            <div class="navbar-dropdown">
                                <a href="StaffDashboardYesterday.jsp" class="navbar-item">
                                    <h1><span>Yesterday</span></h1>
                                </a>
                ...
                <div class="grid gap-6 grid-cols-1 md:grid-cols-3 mb-6">
                    <%
                        for (Booking booking : bookinglist){
                            ...
                            if(booking.getBookingDate().equals(tomorrow)){
                                ...
                                <div class="widget-label">
                                    <h3>
                                        ...
                                        <span class="icon text-blue-500">
                                            <a href="StaffDashboardTomorrow.jsp">
                                                <i class="mdi mdi-format-list-bulleted" data-bs-toggle="tooltip" title="Click to back.">
                                                </i>
                                            </a>
                                        </span>
                                    </h3>
                                    <h2>
                                        Online Customer - <%=totalticket%> &nbsp; &nbsp; <a href="../CUSTOMER/CustInvoice.jsp?id=all&date=<%=tomorrow%>"><i class="mdi mdi-eye"></i></a>
                                    </h2>
                                    <%
                                        int total = 0;
                                        ...
                                        for (BookingStaff bookingstaff : bookingstafflist){
                                            ...
                                            if(bookingstaff.getBookingDate().equals(tomorrow)){
                                    ...
                                    %>
                                    <h2>
                                        Walk-in Customer - <%=total%> &nbsp; &nbsp; <a href="StaffInvoice.jsp?id=all&date=<%=tomorrow%>"><i class="mdi mdi-eye"></i></a>
                                    </h2>
                                </div>
