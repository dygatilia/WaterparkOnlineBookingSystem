                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <%
                            ...
                            CheckoutStaff checkout = checkoutdao.retrieveCheckoutStaffByCheckoutStaffId(checkoutid);
                        ...
                        <form action="../BookingStaffController">
                                ...
                                <div class="control">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <label><%=checkout.getPaymenttype()%></label>
                                            </td>
                                        </tr>
                                        <%--<tr>
                                            <td>
                                            ...
                                            <td>
                                                <label>RM <%=checkout.getCheckoutamount()%>0</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Promotions Discount:</label>
                                            </td>
                                            <td><label class="label"></label></td>
                                            <td>
                                                <label></label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="label">RM <%=totalamount%>0</label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <input type="hidden" name="bookstaffid" value="<%=checkout.getBookid()%>"/>
                            ...
                            <input type="hidden" name="orderstaffstatus" value="Valid"/>
                            <div class="field grouped">
                                <div class="control">
                                    <button type="submit" name="command" value="cancelCheckout" class="button red">
                                        Cancel
                                    </button>
                                </div>
                                <div class="control">
                                    <button type="submit" name = "command" value = "savePayment" class="button green">
                                        Pay
                                    </button>
                                </div>
                            </div>
